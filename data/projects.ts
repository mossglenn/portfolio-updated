...
export const projectCategories: ProjectCategory[] = [
  {
    ...
    subLabel:
      "Personalized, adaptive learning experiences that respond to learners' needs in real time.",
    children: [
      {
  ...
  },
  {
    ...
    subLabel:
      'Game-based and playful learning designs that engage learners with challenging concepts.',
    children: [
      {
        label: 'Collaborative Game-Based Learning Design',
        subLabel:
          'Explore how interdisciplinary teams create game-based learning experiences that engage and teach.',
      ...
      },
      {
        ...
        subLabel:
          'See how play-based experiences turn engineering and physics into real learning for kids—at scale.',
      ...
      },
      {
        ...
        subLabel:
          'Experience a game that flips accessibility expectations—what happens when the tables are turned?',
  ...
  },
  {
    ...
    subLabel:
      'Training that goes beyond compliance to foster ethical action, inclusion, and cultural humility.',
    children: [
      {
  ...
  },
  {
    ...
    subLabel:
      'Helping researchers and innovators transform complex ideas into usable, actionable learning tools.',
    children: [
      {
        label: 'Helping Researchers Turn Ideas into Impact',
        subLabel:
          'See how learning experiences make complex research usable and actionable in the real world.',
  ...
  },
  {
    ...
    subLabel:
      'Agile learning and microlearning strategies that deliver training at scale without sacrificing quality.',
    children: [
      {
        label: 'Solving a Design Dilemma with Microlearning',
        subLabel:
          'Building digital literacy skills through microlearning that meets learners where they are.',
      ...
      },
      {
        ...
        subLabel:
          'Learn how agile approaches power fast, scalable training for large, high-impact audiences.',
...
export function getCategoryByProjectPath(path: string): ProjectCategory | undefined {
  return projectCategories.find((category) =>
    category.children.some((project) => project.path === path)
  )
}
...
export function getCategoryByProjectHref(href: string): ProjectCategory | undefined {
  return projectCategories.find((category) =>
    category.children.some((project) => project.path === href)
  )
}
