...
export const Iceberg = (): ReactElement => {
  return (
    <div className="relative mx-auto w-full max-w-4xl">
      ...
      <div className="animate-float pointer-events-none absolute inset-0 z-0 flex items-start justify-center">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g className="fill-[hsl(var(--ice-layer-4))]" id="below-water-4">
          ...
          <g className="fill-[hsl(var(--ice-layer-3))]" id="below-water-3">
          ...
          <g className="fill-[hsl(var(--ice-layer-2))]" id="below-water-2">
          ...
          <g className="fill-[hsl(var(--ice-layer-1))]" id="below-water-1">
          ...
          <g className="fill-[hsl(var(--ice-top))]" id="above-water-0">
