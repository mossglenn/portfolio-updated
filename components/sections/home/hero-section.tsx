      ...
      <CardContent className="p-6">
        ...
        >
          ...
          >
            ...
            <div className="order-1 w-full md:col-span-2 md:row-start-1">
              <div title="hero-text" className="font-display w-full text-balance text-left md:my-8">
                ...
                <h1 className="text-md-squish mt-2 max-w-full text-[clamp(1.25rem,8vw,3.5rem)] font-bold leading-none">
                  ...
                  <span className="text-gradient-accent-lighter-left font-black">
                    design solutions
                  </span>
                </h1>
            ...
            {/* Subtext */}
            <div className="order-2 md:col-start-3 md:row-span-2">
                ...
                <div className="mb-6 hidden grow flex-nowrap items-center pr-4 text-xs lg:flex">
                  ...
                  <div className="flex flex-nowrap items-center">
                    <div className="-mr-1 -skew-x-20 rounded-md border-2 border-slate-light bg-slate-light p-2 text-center">
                      <div className="inline-block skew-x-20 text-neutral">
