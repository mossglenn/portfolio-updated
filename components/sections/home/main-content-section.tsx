        ...
        <div className="prose prose-lg prose-invert max-w-none">
          <div className="mb-8 rounded-r-lg border-l-4 border-primary bg-muted/80 p-6 backdrop-blur-sm">
            <p className="text-xl italic text-foreground/90">
              ...
              <br />
              Me:{' '}
              <em className="gradient-text-ochre">"What makes you think we need this course?"</em>
            </p>
          </div>
          ...
          <p>
            ...
            meant to solve&mdash;what you want learners to know and be able to do that they can't
            already, and why those outcomes matter to them.
          </p>

          <p>
            Once we're designing solutions, everything else falls into place. We can create focused
            learning activities, curate purposeful content, and build diagnostic assessments that
